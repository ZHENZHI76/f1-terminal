...
export const COMMAND_REGISTRY: CommandDefinition[] = [
    {
        ...
        category_cn: "量化遥测",
        supportsRaw: true,
        notes: "Accepts FP1/FP2/FP3/Q/S/SS/SQ/R. Omit DRIVER_B for single-driver mode. -R for raw data.",
        notes_cn: "接受 FP1/FP2/FP3/Q/S/SS/SQ/R。省略 DRIVER_B 为单车手模式。-R 获取原始数据。",
    },
    {
        command: "SEC",
